...
biblealignlib is a Python library for managing word-level alignments between Bible source texts (Hebrew/Greek manuscripts) and target translations. It implements the Scripture Burrito Alignment Standard v0.3 and supports both manual alignment curation and automated alignment verification.
