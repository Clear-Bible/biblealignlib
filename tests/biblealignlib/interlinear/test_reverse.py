...
from biblealignlib.burrito import CLEARROOT, AlignmentSet, Manager, Source, Target
...
class TestReader:
    ...
    def test_source_alignments_via_manager(self, reader_with_exclude: Reader, mgr: Manager) -> None:
    ...
    def test_target_alignments_via_manager(self, reader_with_exclude: Reader, mgr: Manager) -> None:
        ...
        assert all(
            isinstance(s, Source)
            for sourcelist in target_alignments.values()
    ...
    # failing but i'm not sure why: Claude code
    ...
    def test_source_only_tokens(self, reader_with_exclude: Reader) -> None:
        ...
        source_only = [
            at for at in reader_with_exclude.aligned_tokens if at.sourcetoken and not at.targettoken
        ]
